...
We haven’t, of course. That’s (probably) not our world. Plenty of what was intractable will remain so. It feels that way, though, maybe in the same way we imagined flying cars and rooftop aerodromes alongside airlines and supersonic flight. We knew that aircraft were revolutionary, but weren’t quite sure where the revolution would lead.
